...
def index():
    ...
    return render_template('main/index.html', header=HEADER, heading=heading, description=description)
...
def home():
    ...
    data = {'name': current_user.user_name, 'email': current_user.email, 'role': current_user.role_id}
